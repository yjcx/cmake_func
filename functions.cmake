...
function(delegate_foreach_list FUNC_NAME ARG_LIST)
  if(NOT COMMAND ${FUNC_NAME})
    message(FATAL_ERROR "Function '${FUNC_NAME}' not found")
  endif()
  foreach(item IN LISTS ${ARG_LIST})
    cmake_language(CALL ${FUNC_NAME} ${item} ${ARGN})
  endforeach()
endfunction()

function(delegate_foreach_args FUNC_NAME)
  if(NOT COMMAND ${FUNC_NAME})
    message(FATAL_ERROR "Function '${FUNC_NAME}' not found")
  endif()
  foreach(item IN LISTS ARGN)
    cmake_language(CALL ${FUNC_NAME} ${item})
  endforeach()
endfunction()
